...
#https://github.com/sandipde/Hungarian-Murty/blob/master/Hungarian-Murty.py
...
def k_best_costs(nbest,matrix):
  ...
  hun_list=[hun] # list containing the assignments
  for pair in hun:
...
#  partition_list(a,node_list,cost_list,rsrv_list)
  for x in range (0,nbest-1):
    ...
    partition_list(node_list[min_index],node_list,cost_list,rsrv_list, hun_list)
    cost_list[min_index]=10E6
  return hun_list
  
def partition_list(matrix,node_list,cost_list,rsrv_list, hun_list):
  pair=[]
